...
/// @nodoc
class __$$_ErrorCopyWithImpl<$Res> extends _$InitialStateCopyWithImpl<$Res>
...
class _$_Success implements _Success {
  const _$_Success({required final List<Record> records}) : _records = records;
  ...
  @override
  String toString() {
    return 'InitialState.success(records: $records)';
  }
...
abstract class _Success implements InitialState {
  const factory _Success({required final List<Record> records}) = _$_Success;
