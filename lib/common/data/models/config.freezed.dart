...
class _$ConfigTearOff {
  ...
  _Config call({required List<Record> records}) {
    return _Config(
      records: records,
    );
  }
...
class _$_Config implements _Config {
  _$_Config({required this.records});
...
abstract class _Config implements Config {
  factory _Config({required List<Record> records}) = _$_Config;
